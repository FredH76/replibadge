...
public class LibraryLogging {
    ...
    public static enum LocalLoggingLevel {
        LOG_ADB_OFF, LOG_ADB_INFO, LOG_ADB_WARN, LOG_ADB_ERROR, LOG_ADB_DEBUG, LOG_ADB_VERBOSE,
    };
    ...
    public static class LogEntry {
        ...
        /**
         * Obtains the line number of the last calling function. Useful when combined
         * with the TAG string parameter to the ADB Log.* commands for printing more
         * useful output.
         * 
        ...
        public Intent broadcastAsIntent() {
            ...
            logMsgIntent.putExtra("SourceCodeRefs", usesSourceCodeAcct
                    ? String.format(Locale.ENGLISH, "%s:%s @ %d", invokingClassTag, invokingMethodName,
                            invokingLineNumber)
                    : "");
        ...
        public static boolean writeLogsToXMLFile() {
            ...
            try {
                ...
                for (int log = 0; log < loggingQueue.size(); log++) {
                    ...
                    String[] logXMLEntry = new String[] { "<LogEntry>", XMLTAG("LogID", String.valueOf(le.uniqueLogID)),
                            XMLTAG("TimeStamp", le.logTimestamp), XMLTAG("Level", le.logSeverity),
                ...
                for (int log = 0; log < loggingQueue.size(); log++) {
                    ...
                    String[] ptLogs = new String[] {
                            String.format(Locale.ENGLISH,
                                    "============================== #% 8x @ %s ==============================",
                                    le.uniqueLogID, le.logTimestamp),
    ...
    /****
     * Now we define local versions of the standard ADB logging functions for
     * replacements of the defaults in our library.
     ****/
    public static boolean SUPPORT_ADB_LOGGING = true;

    public static void v(String TAG, String MSG) {
        if (LocalLoggingLevel.LOG_ADB_VERBOSE.compareTo(localLoggingLevel) <= 0
                && localLoggingLevel.compareTo(LOG_ADB_OFF) != 0) {
    ...
    public static void d(String TAG, String MSG) {
        if (LocalLoggingLevel.LOG_ADB_DEBUG.compareTo(localLoggingLevel) <= 0
                && localLoggingLevel.compareTo(LOG_ADB_OFF) != 0) {
    ...
    public static void i(String TAG, String MSG) {
        if (LocalLoggingLevel.LOG_ADB_INFO.compareTo(localLoggingLevel) <= 0
                && localLoggingLevel.compareTo(LOG_ADB_OFF) != 0) {
    ...
    public static void w(String TAG, String MSG) {
        if (LocalLoggingLevel.LOG_ADB_WARN.compareTo(localLoggingLevel) <= 0
                && localLoggingLevel.compareTo(LOG_ADB_OFF) != 0) {
    ...
    public static void e(String TAG, String MSG) {
        if (LocalLoggingLevel.LOG_ADB_ERROR.compareTo(localLoggingLevel) <= 0
                && localLoggingLevel.compareTo(LOG_ADB_OFF) != 0) {
    ...
    public static File createTimestampedLogFile(String baseDirectory, String outputFilePath) {
        String extStoragePathPrefix = Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS)
                .getAbsolutePath();
        File outputFile;
        try {
